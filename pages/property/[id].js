...
const PropertyDetails = ({PropertyDetails: { price, rentFrequency, rooms, title, baths, area, isVerified, description, type, purpose, furnishingStatus, amenities, photos, agency}}) => (
